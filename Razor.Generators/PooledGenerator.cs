// -----------------------------------------------------------------------
// <copyright file="PooledGenerator.cs" company="Razor">
...
/// <remarks>This generator scans all classes within the compilation to identify those annotated with Razor.Attributes.PooledAttribute, ensuring they are partial, and then emits the necessary source code to enable object pooling functionality.</remarks>
/// <example>This generator requires the target classes to:<list type="bullet"><item>Be marked with Razor.Attributes.PooledAttribute.</item><item>Be declared as partial.</item></list>The generator will skip invalid or duplicate entries during compilation.</example>
    ...
    private static string GenerateObjectPoolPartial(string? ns, string typeName, string accessModifier)
    {
        ...
        return $$"""
            ...
            {{accessModifier}} partial class {{typeName}}
            {
                ...
                /// <remarks>The instance is returned to the pool when it is disposed.</remarks>
                public static void Return([NotNull] {{typeName}} obj) => s_pool.Return(obj);
